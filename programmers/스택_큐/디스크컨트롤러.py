...
#     size = 0
#     while i < len(jobs):
#         if p[0] <= jobs[i][0] and sum(p) >= jobs[i][0]:
#             heapq.heappush(hq,(jobs[i][1],jobs[i][0]))
#             i += 1
#     size += len(hq)
#
#     while len(hq) > 0:
#         runtime, start = heapq.heappop(hq)
#         answer += runtime + finish - start
#         finish += runtime
#
#     return answer//size
#             # heapq.heappush(hq,(sum(p),jobs[i][1],jobs[i][0]))
#             # i += 1
#     p
#     heapq.heappop(hq)
#     hq
...
jobs = [[0, 3], [1, 9], [2, 6], [25,5]]
jobs = [[0, 3], [1, 9], [2, 6]]
jobs =  [[0, 3], [1, 9], [2, 6], [4, 3], [25,5]]
