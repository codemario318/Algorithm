...
2 초	128 MB	11440	5675	4557	52.573%
문제
...
def solution(queue,m):
    count = 0
    next = max(queue,key=lambda x:x[1])
...
for _ in range(t):
    ...
    queue = deque(enumerate(map(int,stdin.readline().split())))
    print(solution(queue,m))
