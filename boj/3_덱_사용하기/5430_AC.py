...
1 초	256 MB	13108	2869	1721	19.195%
문제
...
# ac(['42'],'DD',1)
# ac(['42'],'D',1)
# ac(['1','1','2','3','5','8'],'RRD',6)
# ac(['1','1','2','3','5','8'],'RRDR',6)
# ac([],'D',0)
# ac([],'R',0)
# ac([],'RRR',0)
# ac([],'RRRR',0)
...
def ac(deq,commands,n):
    ...
    return '['+','.join(reversed(deq) if r else deq)+']'
...
for _ in range(t):
    ...
    deq = stdin.readline()[1:-2].split(',')
    if deq == ['']:
        deq = []
    print(ac(deq,commands,n))
